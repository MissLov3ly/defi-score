...
def fetch_data_for_nuo_pool(token):
    ...
    return create_pool_data_object(token, total_supply, total_borrow)
...
def fetch_data_for_ddex_pool(token):
    ...
    return create_pool_data_object(token, total_supply, total_borrow, collateral)
